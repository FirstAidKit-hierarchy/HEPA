...
export const caseStudiesContent = {
  ...
  title: "Project structures for market access and evidence teams",
  description:
    "Examples of how HEPA supports pricing, evidence, and stakeholder-engagement projects across the GCC.",
  studies: [
    {
      ...
      result:
        "The team received a clearer basis for pricing and access planning discussions.",
    },
    {
      ...
      result:
        "Stakeholders had a more structured evidence package for internal decision-making.",
    },
    {
      ...
      result:
        "The team had a clearer picture of local concerns and discussion points.",
    },
  ] satisfies CaseStudy[],
};
